...
class LoginForm implements FormModel<Login, Login> {
  ...
  static const String stayControlName = "stay";
  ...
  String stayControlPath() => pathBuilder(stayControlName);

  String get _emailValue => emailControl.value ?? "";

  String get _passwordValue => passwordControl.value ?? "";

  bool get _stayValue => stayControl.value as bool;
  ...
  bool get containsStay {
    try {
      form.control(stayControlPath());
      return true;
    } catch (e) {
      return false;
    }
  ...
  Map<String, Object> get stayErrors => stayControl.errors;

  void get emailFocus => form.focus(emailControlPath());

  void get passwordFocus => form.focus(passwordControlPath());

  void get stayFocus => form.focus(stayControlPath());
  ...
  void stayValueUpdate(
    bool value, {
    bool updateParent = true,
    bool emitEvent = true,
  }) {
    stayControl.updateValue(value,
        updateParent: updateParent, emitEvent: emitEvent);
  }
  ...
  FormControl<bool> get stayControl =>
      form.control(stayControlPath()) as FormControl<bool>;
  ...
  void staySetDisabled(
    bool disabled, {
    bool updateParent = true,
    bool emitEvent = true,
  }) {
    if (disabled) {
      stayControl.markAsDisabled(
        updateParent: updateParent,
        emitEvent: emitEvent,
      );
    } else {
      stayControl.markAsEnabled(
        updateParent: updateParent,
        emitEvent: emitEvent,
      );
    }
  ...
  Login get model {
    ...
    return Login(
        email: _emailValue, password: _passwordValue, stay: _stayValue);
  }
  ...
  static FormGroup formElements(Login? login) => FormGroup({
        ...
        passwordControlName: FormControl<String>(
            ...
            disabled: false,
            touched: false),
        stayControlName: FormControl<bool>(
            value: login?.stay,
            validators: [],
            asyncValidators: [],
            asyncValidatorsDebounceTime: 250,
